...
class DB(dbUrl: String, tableName: String) extends Actor with ActorLogging {
  ...
  def receive = {
    case SaveGoogleResponse(unformattedAddress, googleResponse) =>
      ...
      executeOneRowUpdate(SQL"update #$tableName set googleResponse=$googleResponse, parseGoogleResponseStatus=null, numResults=null, locality=null, areaLevel1=null, areaLevel2=null, areaLevel3=null, postalCode=null, country=null, lat=null, lng=null, formattedAddress=null where unformattedAddress=$unformattedAddress")
    ...
    case SaveGoogleResponseAndEmptyResult(unformattedAddress, googleResponse) =>
      ...
      executeOneRowUpdate(SQL"update #$tableName set googleResponse=$googleResponse, parseGoogleResponseStatus='OK', numResults=0, locality=null, areaLevel1=null, areaLevel2=null, areaLevel3=null, postalCode=null, country=null, lat=null, lng=null, formattedAddress=null where unformattedAddress=$unformattedAddress")
